...
VALUES ('123 Calle Principal, Ciudad', 150.75, '
2024-08-10', '2024-08-15', 1, 1);
select numeroPedido from Pedidos where direccion='123 Calle Principal, Ciudad'and montoTotal= 150.75 and fechaDeEntrega='2024-08-10'
	and fechaDeRetorno='2024-08-15' and codigoCliente=1 and codigoEmpleado=1;
    INSERT INTO Compras (descripcion, montoTotal, fechaDeCompra, estado) VALUES ('Compra de mesas y sillas', 1500.75, '2024-01-20', 'Completado');
    INSERT INTO Proveedores (NITProveedor, nombreProveedor, apellidoProveedor, razonSocial, contactoPrincipal, paginaWeb) VALUES ('0987654321', 'Carlos', 'Martínez', 'Eventos Martínez', 'carlos@martinez.com', 'www.eventosmartinez.com');
    INSERT INTO CategoriaProducto (categoria, tipoDeProducto, color, marca) VALUES ('Mobiliario', 'Mesa', 'Blanco', 'Ikea');
    INSERT INTO Producto (producto, descripcion, costoRenta, existencia, tamanio, codigoCategoriaProducto) VALUES ('Mesa Redonda', 'Mesa redonda de 1.5m de diámetro', 25.00, 20, 'Grande', 1);
    INSERT INTO DetalleCompra (cantidad, costo, direccion, subTotal, fechaReception, codigoProveedor, codigoProducto, numeroCompra) VALUES
(10, 5.99, 'Calle Principal 123, Ciudad', 59.90, '2024-06-15', 1, 1, 1),
(5, 12.50, 'Avenida Central 456, Pueblo', 62.50, '2024-07-20', 1, 1, 1),
(8, 3.75, 'Calle Secundaria 789, Ciudad', 30.00, '2024-08-01', 1, 1, 1); 
